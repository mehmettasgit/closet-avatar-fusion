...
export const PhotoUploader: React.FC<PhotoUploaderProps> = ({
  ...
  return (
    <div className="space-y-4">
      <label htmlFor="portrait-upload" className="block text-sm font-medium text-foreground">
      ...
      >
        <input
          ...
          disabled={disabled}
          className="hidden"
          aria-label="Portrait image file input"
        />
        ...
        {file ? (
          ...
          <div className="text-center py-8">
            ...
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium">Upload your portrait</span>
            </div>
